...
class KNCTableRenderer1 implements TableCellRenderer {
  private static final int YELLOW = 400;
  private static final int RED = 200;

  public KNCTableRenderer1(JTable table) {
    TableColumnModel columnModel = table.getColumnModel();
    columnModel.getColumn(KNCTableModel.COLUMN_STACKER).setCellRenderer(this);
  }
